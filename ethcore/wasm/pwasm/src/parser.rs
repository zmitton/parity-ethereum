...
// TODO: reuse wasm_exec_common::parser::payload fn if possible
...
pub fn payload<'a>(
        ...
        parser::payload(params, &gas_rules(wasm_costs), wasm_costs.max_stack_height)
}
