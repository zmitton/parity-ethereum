...
pub fn restoration_db_handler(client_path: &Path, client_config: &ClientConfig, num_columns: Option<u32>) -> Box<BlockChainDBHandler> {
	let client_db_config = helpers::client_db_config(client_path, client_config, num_columns);
...
/// Open a new main DB.
pub fn open_db(client_path: &str, cache_config: &CacheConfig, num_columns: Option<u32>, compaction: &DatabaseCompactionProfile) -> io::Result<Arc<BlockChainDB>> {
